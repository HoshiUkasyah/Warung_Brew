...
GROUP BY id_order ORDER BY id_order DESC");
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_order.php"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput" name="meja"
                                                placeholder="meja" required>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" name="pelanggan"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit_order_validate"
                                    ...
                                    <form class="needs-validation" novalidate action="proses/proses_edit_order.php"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="uploadFoto" name="kode_order"
                                                        placeholder="kode order" value="<?php echo $row['id_order'] ?>"
                                                        readonly>
                                                    <label for="uploadFoto">Kode Order</label>
                                                    <div class="invalid-feedback">
                                                        Masukan Kode Order
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" name="meja"
                                                        placeholder="meja" value="<?php echo $row['meja'] ?>" required>
                                                    <label for="floatingInput">Meja</label>
                                                    <div class="invalid-feedback">
                                                        Masukan Nomor Meja
                                                    </div>
                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" name="pelanggan"
                                                        placeholder="pelanggan" value="<?php echo $row['pelanggan'] ?>"
                                                        required>
                                                    <label for="floatingInput">Pelanggan</label>
                                                    <div class="invalid-feedback">
                                                        Masukan Nama Pelanggan
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_delete_order.php"
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <b><?php echo $row['id_order'] ?></b> pada meja <b><?php echo $row['meja'] ?></b>?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo (!empty($row['id_bayar'])) ? "<span class='badge bg-success'>Sudah Bayar</span>" : "<span class='badge bg-danger'>Belum Bayar</span>" ?></td>

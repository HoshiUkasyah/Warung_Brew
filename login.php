...
<head>
    ...
    <title>Warung Brew - Aplikasi Pemesanan Makanan dan Miniman</title>
...
<body class="text-center">
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="proses/proses_login.php" method="POST">
            <i class="bi bi-cup-hot me-2 fs-1"></i>
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit" name="submit_validate"
                value="hasil">Login</button>
            <p class="mt-5 mb-3 text-muted">&copy; 2024 - <?php echo date('Y'); ?> Warung Brew</p>
        </form>
    </main>
    <script>

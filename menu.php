...
$query = mysqli_query($conn, "SELECT * FROM tb_menu LEFT JOIN tb_kategori_menu ON tb_kategori_menu.id_kat_menu = tb_menu.kategori");
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_menu.php"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group mb-3">
                                            <input type="file" class="form-control py-3 " id="uploadFoto" name="foto"
                                                placeholder="foto menu" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" name="nama_menu"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" name="keterangan"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput" name="stok"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit_menu_validate"
                                    ...
                                    <form class="needs-validation" novalidate action="proses/proses_input_menu.php"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" aria-label="Default select example"
                                                        value="<?php echo $row['kategori'] ?>" disabled>
                                                        <option selected hidden value="">Pilih Kategori Menu</option>
                                                        <?php
                                                        foreach ($select_kat_menu as $value) {
                                    ...
                                    <form class="needs-validation" novalidate action="proses/proses_edit_menu.php" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="input-group mb-3">
                                                    <input type="file" class="form-control py-3 " id="uploadFoto" name="foto"
                                                        placeholder="foto menu" value="<?php echo $row['foto'] ?>" required>
                                                    <label class="input-group-text" for="uploadFoto">Upload Foto Menu</label>
                                                    <div class="invalid-feedback">
                                                        Masukan Foto Menu
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" name="keterangan"
                                                        placeholder="keterangan" value="<?php echo $row['keterangan'] ?>">
                                                    <label for="floatingPassword">Keterangan</label>
                                                    <div class="invalid-feedback">
                                                        Masukan Keterangan Menu
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" name="harga"
                                                        placeholder="Harga" value="<?php echo $row['harga'] ?>" required>
                                                    <label for="floatingInput">Harga</label>
                                                    <div class="invalid-feedback">
                                                        Masukan Harga Menu
                                                    </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" name="stok"
                                                        placeholder="Stok" value="<?php echo $row['stok'] ?>" required>
                                                    <label for="floatingInput">Stok</label>
                                                    <div class="invalid-feedback">
                                                        Masukan Stok Menu
                                                    </div>

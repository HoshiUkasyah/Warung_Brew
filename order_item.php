...
$query = mysqli_query($conn, "SELECT *, SUM(harga*jumlah) AS total, tb_order.waktu_order FROM tb_list_order 
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="meja" value="<?php echo $meja; ?>" disabled>
                ...
                <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_order_item.php"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit_order_item_validate"
                    ...
                    <div class="modal fade" id="ModalEdit<?php echo $row['id_list_order'] ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_edit_order_item.php"
                                        method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" name="jumlah"
                                                        placeholder="jumlah" required value="<?php echo $row['jumlah'] ?>">
                                                    <label for="floatingInput">Jumlah</label>
                                                    <div class="invalid-feedback">
                                                        Masukan Jumlah Porsi
                                                    </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <button type="submit" class="btn btn-primary" name="edit_order_item_validate"
                                                value="1234">Edit Item</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="modal fade" id="ModalDelete<?php echo $row['id_list_order'] ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-md modal-fullscreen-md-down">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_delete_order_item.php"
                                        method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_bayar.php" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" id="floatingInput" name="uang"
                                                    placeholder="jumlah" required>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button
                                                class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-warning me-1"; ?> btn-sm me-1"
            ...
            <div>
                <button
                    ...
                    data-bs-toggle="modal" data-bs-target="#ModalTambahItem"><i
                        class="bi bi-plus-circle me-1"></i>Item</button>
                <button
                    class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-primary"; ?>"
                    data-bs-toggle="modal" data-bs-target="#ModalBayar"><i
                        class="bi bi-cash-coin me-1"></i>Bayar</button>
                <button class="btn btn-info" onclick="cetakStruk()"><i class="bi bi-printer"></i></button>
            </div>
        </div>
    </div>
</div>

<div id="strukKonten" style="display: none;">
    <style>
        #struk {
    ...
    <div id="struk">
        <h2>Struk Pembayaran Warung Brew</h2>
...
<script>
    function cetakStruk() {
        var strukKonten = document.getElementById('strukKonten').innerHTML;
        var cetakFrame = document.createElement('iframe');
        
        cetakFrame.style.display = 'none';
        document.body.appendChild(cetakFrame);
        
        var frameDoc = cetakFrame.contentDocument || cetakFrame.contentWindow.document;
        frameDoc.open();
        frameDoc.write('<html><head><title>Struk Pembayaran</title>');
        frameDoc.write('<style>');
        frameDoc.write('body { margin: 0; padding: 0; font-family: Arial, sans-serif; }');
        frameDoc.write('</style>');
        frameDoc.write('</head><body>');
        frameDoc.write(strukKonten);
        frameDoc.write('</body></html>');
        frameDoc.close();
        
        setTimeout(function() {
            cetakFrame.contentWindow.focus();
            cetakFrame.contentWindow.print();
            document.body.removeChild(cetakFrame);
        }, 300);
    }
</script>